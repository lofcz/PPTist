    ...
    <div class="configs">
      ...
      <div class="row">
        ...
        <div class="config-item">
          <Switch v-model:value="ignoreMedia" v-tooltip="'The audio and video will be ignored by default when exporting. If there are audio and video elements in your slides and you want to export them to the PPTX file, you can choose to turn off the [Ignore Audio/Video] option, but note that this will greatly increase the export time.'" />
        </div>
      </div>
      <div class="row">
      ...
      <div class="tip" v-if="!ignoreMedia">
        Note: 1. Supported export formats: avi, mp4, mov, wmv, mp3, wav; 2. Cross-domain resources cannot be exported.
      </div>
    </div>
    <div class="btns">
