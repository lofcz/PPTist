<template>
  <div class="image-style-panel">
    ...
    <ButtonGroup class="row" passive>
      <Button first style="width: calc(100% / 6 * 5);" @click="clipImage()"><IconTailoring class="btn-icon" /> Clip Image</Button>
    ...
    <div class="row">
      <div style="width: 40%;">Rounded Corners:</div>
      <NumberInput 
...
const getImageElementDataBeforeClip = () => {
  ...
  // Image current position, size and clip range
...
const presetImageClip = (shape: string, ratio = 0) => {
  ...
  // Aspect ratio clip (shape fixed to rectangle)
  if (ratio) {
