...
export const useSlidesStore = defineStore('slides', {
  ...
  getters: {
    ...
    // Merge items triggered by "With Previous" upwards to the same position in the sequence
    // Add automatic downward execution flag to the previous item of the trigger condition "After Previous"
