...
export const readClipboard = (): Promise<string> => {
  return new Promise((resolve, reject) => {
    ...
    else reject('Browser does not support or prohibits access to the clipboard, please use the shortcut Ctrl + V')
  })
}
...
// Try to parse whether the clipboard content is Excel table (or similar) data format
