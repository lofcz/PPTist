...
export const ENTER_ANIMATIONS = [
  {
    ...
    children: [
      ...
      { name: 'Bounce In from Right', value: 'bounceInLeft' },
      { name: 'Bounce In from Left', value: 'bounceInRight' },
      { name: 'Bounce In from Up', value: 'bounceInUp' },
      { name: 'Bounce In from Down', value: 'bounceInDown' },
    ],
  },
  {
    type: 'fade',
